...
// explicit commodity, total-price value positions, and two or more postings.
// Timestamps without an offset, transaction codes, metadata, unit prices,
// opening positions, costs, tags, and price database directives are not emitted
// or parsed. Compatibility is checked against Tackler 26.1.2 or later and the
