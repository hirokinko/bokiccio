...
- reporting calendarの単月、会計年度途中までの年度累計、設定済み会計年度全体を対象にした損益計算書（P/L）
- 5区分と未分類を含む12か月の全勘定残高推移
- 試算表と単月・年度累計・通期P/Lのaccount集計値から承認済み仕訳・寄与postingへ戻るdrill-down
